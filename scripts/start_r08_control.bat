...
echo After CONTROL_AWAKE, switch to the app you want to control.
echo Copy and paste are ignored while this console is in front, so Ctrl+C cannot close the controller.

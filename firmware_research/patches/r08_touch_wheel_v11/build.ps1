...
$objectPath = Join-Path $buildRoot 'r08_touch_wheel_v11.o'
$elfPath = Join-Path $buildRoot 'r08_touch_wheel_v11.elf'
$binaryPath = Join-Path $buildRoot 'r08_touch_wheel_v11.bin'
